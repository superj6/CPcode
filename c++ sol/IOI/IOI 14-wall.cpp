/*
  Hold left and right bound for each interval and push operations down segtree lazily. This will make sure once you push min and max
all the way down a tree all important operations will be applied in the correct order since higher values will have happened after
lower values in the tree.
*/
